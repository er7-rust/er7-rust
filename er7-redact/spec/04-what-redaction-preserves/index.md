[`er7-redact` specification](../index.md) — section 4 of 17. Section
numbers (§4.x) are stable and cited from code, tests, and commit messages.
...
purpose (D6, [§3.4](../03-actions/index.md)).
...
write one ([§3.3](../03-actions/index.md)).
