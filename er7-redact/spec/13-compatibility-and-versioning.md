[`er7-redact` specification](index.md) — section 13 of 17. Section numbers (§13.x) are stable and cited from code, tests, and commit messages.
...
new action with a new name ([§16.3](16-open-questions-and-declined-decisions.md)).
...
Every change to the table is a change to [§5.1](05-built-in-policies.md)
in the same commit, and appears in the release notes.
