[`er7-redact` specification](../index.md) — section 7 of 17. Section
numbers (§7.x) are stable and cited from code, tests, and commit messages.
...
- **Stable.** The same key and the same decoded value always produce the
  ...
  every version of Rust, and — by
  [§13](../13-compatibility-and-versioning/index.md) — in every future 0.x
  and 1.x release of this crate. Redacting the same export twice, months
  apart, produces the same output.
