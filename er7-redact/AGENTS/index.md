...
| ----- | -------------- |
| [architecture](architecture.md) | repo layout, modules, the redaction pass, the public API surface |
| [conventions](conventions.md) | coding style, the doc-comment shape, and the properties every change must protect |
| [testing](testing.md) | where a test goes, how to name it, the four checks |
| [safety](safety.md) | patient-safety and privacy constraints — **read before writing behaviour** |
