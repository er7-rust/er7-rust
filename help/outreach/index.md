...
| The MSRV policy is documented, and is a genuine selling point to the integration-engineer audience | **Met** | [`spec/rust-msrv-n-minus-3/`](../../spec/rust-msrv-n-minus-3/index.md); already surfaced in [`INSTALL.md`](../../INSTALL.md) and [`COMPARISONS.md`](../../COMPARISONS.md). Hospital toolchains move in quarters — say so explicitly in any promotional copy, per [§3.2](../../spec/promote/index.md#32-what-we-have-to-promote) |
