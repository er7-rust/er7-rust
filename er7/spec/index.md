...
2. **Every behavioural rule is testable.** Rules carry stable `R<n>` IDs,
   indexed in [§1.4](01-purpose-and-scope.md), and each one names the test
   that enforces it in the §13.1 coverage table.
...
| § | Section | File |
| - | ------- | ---- |
| 1 | Purpose and scope, and the rule index (R1–R25) | [01-purpose-and-scope.md](01-purpose-and-scope.md) |
| 2 | The ER7 encoding (domain background) | [02-er7-encoding.md](02-er7-encoding.md) |
| 3 | Delimiters | [03-delimiters.md](03-delimiters.md) |
| 4 | Parsing | [04-parsing.md](04-parsing.md) |
| 5 | The value tree | [05-value-tree.md](05-value-tree.md) |
| 6 | Escape sequences | [06-escape-sequences.md](06-escape-sequences.md) |
| 7 | Writing and round trip | [07-writing.md](07-writing.md) |
| 8 | Paths and queries | [08-paths-and-queries.md](08-paths-and-queries.md) |
| 9 | Batch and multi-message input | [09-batch-input.md](09-batch-input.md) |
| 10 | MSH conveniences | [10-msh-conveniences.md](10-msh-conveniences.md) |
| 11 | Error handling | [11-error-handling.md](11-error-handling.md) |
| 12 | Command-line interface | [12-command-line-interface.md](12-command-line-interface.md) |
...
[01-purpose-and-scope.md](01-purpose-and-scope.md) §1.4.
