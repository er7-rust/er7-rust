[`er7` specification](../index.md) — section 3 of 19. Section numbers
(§3.x) are stable and cited from code, tests, and commit messages.

# 3. Delimiters

Implemented in `src/separators.rs`. Background in
[§2.3](../02-er7-encoding/index.md).
...
A failing set is `Error::BadHeader` ([§11](../11-error-handling/index.md))
carrying a sentence naming the two roles or the offending character.
Nothing else about a message can fail this way.
