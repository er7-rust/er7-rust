[`er7` specification](../index.md) — section 12 of 19. Section numbers
(§12.x) are stable and cited from code, tests, and commit messages.
...
Input is split per [§9](../09-batch-input/index.md), and
...
- An **explicit null is shown as the `""` it was sent as**, since that is
  ...
  ([§8.2.1](../08-paths-and-queries/index.md)).
