[`er7` specification](../index.md) — section 10 of 19. Section numbers
(§10.x) are stable and cited from code, tests, and commit messages.
...
declined idea in [§18.4](../18-open-questions-and-divergences/index.md).
...
[§8.2](../08-paths-and-queries/index.md)'s treatment of missing positions.
