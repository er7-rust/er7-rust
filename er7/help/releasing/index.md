...
itself — the maintainer no longer has to tick every box personally before
`cargo publish` runs. Scoping and naming the release in the first place
stays the maintainer's alone; see
