...
| `/ecosystem/` | The encoding/dictionary split, the five crates and the two kinds of layer, building your own | crate §1.3, §18.1 |
...
- **Sibling-crate documentation.** Every crate built on `er7` — the HL7
  v2.5 dictionary crates, `er7-redact`, `serde-er7` — has its own
  repository and docs; `/ecosystem/` links to them and explains the
  boundary, and stops there. A sibling gets a card and a row, never a
  route.
