[`er7-redact` specification](index.md) — section 9 of 17. Section numbers (§9.x) are stable and cited from code, tests, and commit messages.
...
policy ([§6.4](06-policy-file-format.md)). A typo there means a value that
should have been redacted silently was not.
