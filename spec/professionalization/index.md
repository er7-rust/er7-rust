...
| 5 | **Met, with the sweep in flight** | `bin/check-trademarks` passes across the working tree (run 2026-08-26); the 100+-file sweep extending compliance into crate doc-comments, manifests, and site copy is uncommitted at the time of this assessment — landing it is the top `tasks.md` item |
